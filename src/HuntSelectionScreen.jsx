...
import { THEMES, getTheme, DIFFICULTY_COLORS, DifficultyPill } from "./lib/theme";
...
// THEMES / getTheme moved to src/lib/theme.jsx (imported above) so
// screens that only need the color data don't have to pull in this
// whole file when route-based code splitting lands.
...
// ── DIFFICULTY PILL ────────────────────────────────────────────
// DIFFICULTY_COLORS / DifficultyPill moved to src/lib/theme.jsx
// (imported above), same reasoning as THEMES/getTheme above.
